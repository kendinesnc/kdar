...
async def start(_, m: Message):
    if m.chat.type == "private":
        await m.reply_text(
            f"✨ **Merhaba, Ben @{Veez.BOT_USERNAME} **\n\n💭 **Sesli sohbetlerinizde video izlemenizi sağlayabilirim "
            f"kolay yol.**\n\n❔ **Nasıl kullanacağınızı görmek için yardım isteyin** 👇🏻",
            reply_markup=InlineKeyboardMarkup(
                [[
                    ...
                    InlineKeyboardButton(
                        "BOT SAHİBİ ", url="https://t.me/Mon_phoenix6761"),
                    InlineKeyboardButton(
                        "📣 Kanal", url="https://t.me/UtagOnline")
                ], [
                    InlineKeyboardButton(
                        "👩🏻‍💻 YARDIM", url="https://t.me/Baykaoss")
                ], [
                    InlineKeyboardButton(
...
@Client.on_message(command(["reload", f"reload@{Veez.BOT_USERNAME}"]) & filters.group & ~filters.edited)
async def reload(_, m: Message):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "✨ Group", url=f"https://t.me/Sohbet10line"
                    ),
                    InlineKeyboardButton(
                        "📣 Channel", url=f"https://t.me/muziksiirkanali"
                    )
                ]
            ]
        )
