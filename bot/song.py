...
@Client.on_message(command(["indir", f"indir@{Veez.BOT_USERNAME}"]) & ~filters.channel)
def song(_, message):
...
@Client.on_message(command(["ara", f"ara@{Veez.BOT_USERNAME}"]) & filters.group & ~filters.edited)
